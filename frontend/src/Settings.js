                ...
                {settings.map(setting => (
                  <li key={setting.id} className="list-group-item d-flex justify-content-between align-items-center">
                    <div>
                      ...
                      <p>Min Value: {setting.minValue} | Max Value: {setting.maxValue} | Max Records Stored: {setting.maxRecordsStored}</p>
                    </div>
                    <div>
              ...
              {selectedSetting && (
                <form className="card p-4" onSubmit={handleSubmit}>
                  ...
                  <div className="form-group">
                    ...
                    <input type="number" name="minValue" className="form-control" value={formValues.minValue} onChange={handleInputChange} />
                  </div>
                  <div className="form-group">
                    <label>Max Value:</label>
                    <input type="number" name="maxValue" className="form-control" value={formValues.maxValue} onChange={handleInputChange} />
                  </div>
                  <div className="form-group">
